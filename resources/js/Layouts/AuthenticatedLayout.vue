        ...
        >
            ...
            <div v-if="isUser && !isAdmin && user" class="px-5 mt-4 shrink-0">
                <div :class="isUserMember ? 'bg-indigo-600 shadow-indigo-100 shadow-lg' : 'bg-slate-100'" 
                    ...
                    <p v-if="isUserMember" class="text-[10px] lg:text-[9px] font-medium text-indigo-200 mt-1.5 leading-none">
            ...
            <nav ref="sidebarNav" class="flex-1 overflow-y-auto py-3 px-4 custom-scrollbar">
                ...
                <div v-if="isAdmin" class="flex flex-col space-y-1 lg:space-y-0">
                    <p class="text-[10px] uppercase font-semibold text-rose-500 px-4 mb-2 lg:mb-1 mt-3 lg:mt-2 tracking-[0.2em]">Admin Control</p>
                    
                    <Link :href="route('admin.dashboard')" :class="[route().current('admin.dashboard') ? 'bg-rose-50 text-rose-600 active-link shadow-sm' : 'text-slate-500 hover:bg-rose-50', 'flex items-center gap-3 lg:gap-2 py-2.5 lg:py-1.5 px-4 rounded-xl font-medium transition-all group relative']">
                    ...
                    <Link :href="route('admin.users.index')" :class="[route().current('admin.users.*') ? 'bg-rose-50 text-rose-600 active-link shadow-sm' : 'text-slate-500 hover:bg-rose-50', 'flex items-center gap-3 lg:gap-2 py-2.5 lg:py-1.5 px-4 rounded-xl font-medium transition-all group relative']">
                    ...
                    <Link :href="route('admin.tryout-akbar.index')" :class="[route().current('admin.tryout-akbar.*') ? 'bg-rose-50 text-rose-600 active-link shadow-sm' : 'text-slate-500 hover:bg-rose-50', 'flex items-center gap-3 lg:gap-2 py-2.5 lg:py-1.5 px-4 rounded-xl font-medium transition-all group relative']">
                    ...
                    <Link :href="route('admin.transactions.index')" :class="[route().current('admin.transactions.*') ? 'bg-rose-50 text-rose-600 active-link shadow-sm' : 'text-slate-500 hover:bg-rose-50', 'flex items-center gap-3 lg:gap-2 py-2.5 lg:py-1.5 px-4 rounded-xl font-medium transition-all group relative']">
                ...
                <div v-if="isUser && !isAdmin" class="flex flex-col space-y-1 lg:space-y-0">
                    <p class="text-[10px] uppercase font-semibold text-slate-400 px-4 mb-2 lg:mb-1 mt-3 lg:mt-2 tracking-[0.2em]">Menu Navigasi</p>
                    
                    <Link :href="route('dashboard')" :class="[route().current('dashboard') ? 'bg-slate-900 text-white shadow-xl active-link' : 'text-slate-500 hover:bg-slate-50', 'flex items-center gap-3 lg:gap-2 py-2.5 lg:py-1.5 px-4 rounded-xl font-medium transition-all group relative']">
                    ...
                    <Link :href="route('tryout-akbar.index')" :class="[route().current('tryout-akbar.*') ? 'bg-slate-900 text-white shadow-xl active-link' : 'text-slate-500 hover:bg-slate-50', 'flex items-center gap-3 lg:gap-2 py-2.5 lg:py-1.5 px-4 rounded-xl font-medium transition-all group relative']">
                    ...
                    <Link :href="route('tryout.adidaya')" :class="[(route().current('tryout.adidaya') || (route().current('tryout.wait') && activeTryoutType === 'adidaya')) ? 'bg-slate-900 text-white shadow-xl active-link' : 'text-slate-500 hover:bg-slate-100', 'flex items-center justify-between py-2.5 lg:py-1.5 px-4 rounded-xl font-medium transition-all group relative']">
                        ...
                        <span v-if="isUserMember" class="text-[9px] lg:text-[8px] bg-indigo-600 text-white px-2 py-0.5 rounded-md font-medium shadow-sm shadow-indigo-200">ACTIVE</span>
                        <span v-else class="text-[9px] lg:text-[8px] bg-slate-200 text-slate-500 px-2 py-0.5 rounded-md font-medium italic">LOCKED</span>
                    </Link>

                    <Link :href="route('membership.index')" :class="[route().current('membership.*') ? 'bg-slate-900 text-white shadow-xl active-link' : 'text-slate-500 hover:bg-slate-50', 'flex items-center gap-3 lg:gap-2 py-2.5 lg:py-1.5 px-4 rounded-xl font-medium transition-all group relative']">
