...
<template>
    ...
    <span class="text-xs lg:text-[11px] uppercase tracking-wider">Kelola Tryout</span>
                    ...
                    <Link :href="route('admin.membership-packages.index')" :class="[route().current('admin.membership-packages.*') ? 'bg-rose-50 text-rose-600 active-link shadow-sm' : 'text-slate-500 hover:bg-rose-50', 'flex items-center gap-3 lg:gap-2 py-2.5 lg:py-2 px-4 rounded-xl font-medium transition-all group relative']">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 flex-shrink-0 text-fuchsia-500"><path stroke-linecap="round" stroke-linejoin="round" d="m21 7.5-9-5.25L3 7.5m18 0-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" /></svg>
                        <span class="text-xs lg:text-[11px] uppercase tracking-wider">Paket Adidaya</span>
                    </Link>
    ...
    <span class="text-xs lg:text-[11px] uppercase tracking-wider">Event Akbar</span>
                    ...
                    <Link :href="route('admin.affiliate.index')" :class="[route().current('admin.affiliate.*') ? 'bg-rose-50 text-rose-600 active-link shadow-sm' : 'text-slate-500 hover:bg-rose-50', 'flex items-center gap-3 lg:gap-2 py-2.5 lg:py-2 px-4 rounded-xl font-medium transition-all group relative']">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 flex-shrink-0 text-teal-500"><path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0a5.995 5.995 0 0 0-4.058-3.036m0 0a5.995 5.995 0 0 0-4.058 3.036m0 0a5.97 5.97 0 0 0-.941 3.197m9.411-3.197a5.971 5.971 0 0 0-.941-3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z" /></svg>
                        <span class="text-xs lg:text-[11px] uppercase tracking-wider">Kelola Afiliasi</span>
                    </Link>

                    <Link :href="route('admin.vouchers.index')" :class="[route().current('admin.vouchers.*') ? 'bg-rose-50 text-rose-600 active-link shadow-sm' : 'text-slate-500 hover:bg-rose-50', 'flex items-center gap-3 lg:gap-2 py-2.5 lg:py-2 px-4 rounded-xl font-medium transition-all group relative']">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 flex-shrink-0 text-yellow-500 group-[.active-link]:text-rose-600">
    ...
    <span class="text-xs lg:text-[11px] uppercase tracking-wider">Pengaturan</span>
                ...
                <div v-if="isUser && !isAdmin" class="flex flex-col space-y-1 lg:space-y-0.5">
                    ...
                    <Link :href="route('tryout.index')" :class="[(route().current('tryout.index') || route().current('tryout.my') || route().current('tryout.register') || (isInsideTryoutScope && activeTryoutType === 'general')) ? 'bg-slate-900 text-white shadow-xl active-link' : 'text-slate-500 hover:bg-slate-50', 'flex items-center gap-3 lg:gap-2 py-2.5 lg:py-2 px-4 rounded-xl font-medium transition-all group relative']">
                    ...
                    <Link :href="route('tryout-akbar.index')" :class="[(route().current('tryout-akbar.*') || (isInsideTryoutScope && activeTryoutType === 'akbar')) ? 'bg-slate-900 text-white shadow-xl active-link' : 'text-slate-500 hover:bg-slate-50', 'flex items-center gap-3 lg:gap-2 py-2.5 lg:py-2 px-4 rounded-xl font-medium transition-all group relative']">
                    ...
                    <Link :href="route('tryout.adidaya')" :class="[(route().current('tryout.adidaya') || (isInsideTryoutScope && activeTryoutType === 'adidaya')) ? 'bg-slate-900 text-white shadow-xl active-link' : 'text-slate-500 hover:bg-slate-100', 'flex items-center justify-between py-2.5 lg:py-2 px-4 rounded-xl font-medium transition-all group relative']">
                    ...
                    <Link :href="route('tryout.history')" :class="[(route().current('tryout.history') && !isInsideTryoutScope) ? 'bg-slate-900 text-white shadow-xl active-link' : 'text-slate-500 hover:bg-slate-50', 'flex items-center gap-3 lg:gap-2 py-2.5 lg:py-2 px-4 rounded-xl font-medium transition-all group relative']">
