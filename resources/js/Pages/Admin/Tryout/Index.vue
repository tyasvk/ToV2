        ...
        <div class="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div class="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-5 relative overflow-hidden">
                ...
                <div class="relative z-10 space-y-1.5">
                    <h1 class="text-2xl md:text-3xl font-medium text-slate-900 tracking-tight">Katalog Tryout</h1>
                    <p class="text-sm text-slate-500 font-medium">Manajemen penjadwalan, tipe akses, harga, dan bank soal.</p>
                </div>
